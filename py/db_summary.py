    ...
    def get_summary(self, summary='pending'):
        ...
        try:
            ...
            for record in records:
                ...
                update_query = f"""
                    UPDATE books
                    SET title_google = %s, author  = %s, summary = %s, isbn = %s, cover_image_url = %s
                    WHERE id = %s;
                """
                self.cursor.execute(update_query, (title_google,  authors, summary, isbn, cover_image, record_id))
